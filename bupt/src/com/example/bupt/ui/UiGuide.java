...
import com.example.bupt.widget.GuidePagerAdapter;

public class UiGuide extends Activity implements OnPageChangeListener {
    ...
    private void initDots() {
        LinearLayout ll = (LinearLayout) findViewById(R.id.guide_image_ll);
