...
public class PushService extends Service
{
	...
	private static final String		MQTT_HOST = "192.168.1.199";
	...
	public static String			MQTT_CLIENT_ID = "wowilling";
	...
	// Notification title
	public static String			NOTIF_TITLE = "wowilling"; 	
	// Notification id
	...
	private boolean wasStarted() {
		...
		return PreferenceUtil.getBooleanPreference(getApplicationContext(), PREF_STARTED);
	}

	// Sets whether or not the services has been started in the preferences.
	private void setStarted(boolean started) {
		//mPrefs.edit().putBoolean(PREF_STARTED, started).commit();		
		PreferenceUtil.setBooleanPreference(getApplicationContext(), PREF_STARTED, started);
		mStarted = started;
	}
	...
	private synchronized void connect() {		
		...
		String deviceID = PreferenceUtil.getStringPreference(getApplicationContext(), PREF_DEVICE_ID);
	...
	public void scheduleReconnect(long startTime) {
		...
		long interval = PreferenceUtil.getLongPreference(getApplicationContext(), PREF_RETRY,INITIAL_RETRY_INTERVAL);
		...
		PreferenceUtil.setLongPreference(getApplicationContext(), PREF_RETRY, interval);
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public MQTTConnection(String brokerHostName, String initTopic) throws MqttException {
	    	...
	    	String mqttConnSpec = "tcp://" + brokerHostName + "@" + MQTT_BROKER_PORT_NUM;
	        	...
	        	String clientID = MQTT_CLIENT_ID + "/" + PreferenceUtil.getStringPreference(getApplicationContext(), PREF_DEVICE_ID);
		...
		public void publishArrived(String topicName, byte[] payload, int qos, boolean retained) {
			...
			if(s.equals(Notice.TYPE_PAOPAO))notice.setPaopaoCount(1);
			if(s.equals(Notice.TYPE_ATME))notice.setAtmeCount(1);
			if(s.equals(Notice.TYPE_COMMENT))notice.setMsgCount(1);
			if(s.equals(Notice.TYPE_MESSAGE))notice.setReviewCount(1);
			if(s.equals(Notice.TYPE_NEWFAN))notice.setNewFriendCount(1);
			UiHelper.sendBroadCast(getApplicationContext(), notice);
			log("Got message: " + s);
		}   
		...
		public void sendKeepAlive() throws MqttException {
			...
			publishToTopic(MQTT_CLIENT_ID + "/keepalive", PreferenceUtil.getStringPreference(getApplicationContext(), PREF_DEVICE_ID));
		}		
	}
}